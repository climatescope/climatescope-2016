...
<a href="https://2016.global-climatescope.org/en/off-grid-data-hub/">The Frontier Power Data Hub </a> is an interactive tool to view market fundamentals and regulations for distributed energy in more than 20 developing countries in Sub-Saharan Africa and Asia (Figure 4). The tool also allows users to assess the size of solar markets by analyzing time series data on PV equipment exports from [China](/en/country/china) by non-OECD countries. 
